...
def traiter_img(img, Nc, Nd, dim_max):
    try:
        ...
        return sorted_cls, total_px, cl_proches, img_arr  # Ajoutez ces valeurs pour les rendre accessibles

    except Exception as e:
        st.error(f"Une erreur est survenue : {e}")
        return None, None, None, None  # Retournez None en cas d'erreur
...
sorted_cls, total_px, cl_proches, img_arr = None, None, None, None  # Initialiser ces variables

if uploaded_file is not None:
    sorted_cls, total_px, cl_proches, img_arr = traiter_img(uploaded_file, Nc, Nd, dim_max)
...
if sorted_cls is not None and total_px is not None:
